...
#define STRING_CONFIG_H_AUTHOR "JE SEnder3" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SEnder3"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 64.18
    #define DEFAULT_Ki 10.84
    #define DEFAULT_Kd 94.99
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi 12.06
  #define DEFAULT_bedKd 444.88
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {    80, 80, 382.85, 678   }
...
// #define CLASSIC_JERK
  ...
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2
    ...
    #define MAX_JERK_EDIT_VALUES { 5, 5, 0.6, 5 } // ...or, set your own edit limits
  #endif
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -18, 7, -0.3   }
